...
from virasana.workers.tasks import celery, processa_bson, processa_carga, processa_predicoes, processa_stats
...
def setup_periodic_tasks(sender, **kwargs):
    ...
    sender.add_periodic_task(61 * 60.0, processa_predicoes.s())  # 61 min
